...
class IndexTest(unittest.TestCase):
    ...
    def case_take_photo(self, times=1):
        ...
        self.mod.back_to_home()
        self.mod.logger.info("take photo %d times completed" % times)
...
if __name__ == '__main__':
    suite1 = unittest.TestLoader().loadTestsFromTestCase(IndexTest)
